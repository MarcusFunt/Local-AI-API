...
This project is indexed by GitNexus as **Local-AI-API** (1691 symbols, 3663 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
