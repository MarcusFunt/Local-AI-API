...
This project is indexed by GitNexus as **Local-AI-API** (1816 symbols, 3924 relationships, 155 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
